...
const Navbar = ({setShowLogin}) => {
  ...
  return (
    <div className={`flex items-center justify-between px-6 md:px-16 lh:px-24
    ...
    ${location.pathname === "/" && "bg-light"}`}>
      ...
      itema-start sm:items-center gap-4 sm:gap-8 max-sm:p-4 transition-all duration-300 z-50
