...
const Sidebar = () => {
  ...
  return (
    ...
    max-w-1/3 md:max-w-60 w-full border-r border-borderColor text-sm'>
      ...
      <div className='group relative'>
         <label htmlFor="image">
            ...
            {
               image && (
                  <button className='absolute top-0 right-0 flex p-2 bg-primary/10 text-primary cursor-pointer' onClick={updateImage}>Save <img src={assets.check_icon} alt="" width={13} /></button>
               )}
